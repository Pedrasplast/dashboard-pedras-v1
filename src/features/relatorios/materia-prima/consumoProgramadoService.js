...
function calcularComHorario({
  ...
  return {
    ...
    dataInicioConsiderada:
      dataIsoDeMs(
        inicio,
      ),

    horaInicioConsiderada:
      horaDeMs(
        inicio,
      ),
        ...
        programacoes:
          [
            ...
            (
              ...
              `${a.dataInicioConsiderada} ${a.horaInicioConsiderada || ""}`
                .localeCompare(
...
export async function buscarConsumoProgramado({
  ...
  for (
    ...
    if (
      !receitaBrutaPorCodigo.has(
        codigo,
      )
    ) {
      receitaBrutaPorCodigo.set(
        codigo,
        [],
      );
    }
