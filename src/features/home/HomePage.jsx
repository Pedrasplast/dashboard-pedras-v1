  ...
  return (
    <div className="home-screen">
      <div className="welcome-banner">
        ...
        <p>
          Visão integrada da produtividade por máquina, identificação de paradas e monitoramento de
          eficiência operacional.
        </p>
      </div>

      <div className={user ? "home-grid home-grid-logged" : "home-grid"}>
          ...
          <div className="action-guide">
            ...
            >
              ...
              <div>
                ...
                <p>
                  Gráficos de eficiência, peças fabricadas, tempos de atividade e análise de
                  paradas.
                </p>
              </div>
            </div>
          ...
          <div className="auth-card">
            <div className="login-form-wrapper">
              ...
              <div className="login-footer-actions">
                ...
                <button type="button" className="btn-link-cadastro" onClick={goToCadastro}>
                  Criar nova conta
                </button>
              </div>
            </div>
