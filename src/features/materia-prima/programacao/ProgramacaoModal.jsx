...
/* =========================================================
   RESUMO DO NOME DO FERIADO
========================================================= */

function resumirNomeFeriado(
  observacao,
) {
  const texto =
    String(
  ...
  const mapa = [
    ...
    [
      /sexta[- ]feira santa|paix[aã]o de cristo/i,
      "PAIXÃO DE CRISTO",
    ],
  ...
  const limpo =
    texto
      .replace(
        /^feriado\s*(nacional|estadual|municipal)?\s*[-–:]?\s*/i,
        "",
      )
      .replace(
        /^dia\s+de\s+/i,
                ...
                <div className="programacao-calendario-grade">
                  ...
                  {diasGrade.map(
                    (
                      ...
                      const feriado =
                        fechado &&
                        /FERIADO|NATAL|TIRADENTES|FINADOS|INDEPEND[ÊE]NCIA|CONSCI[ÊE]NCIA|REP[ÚU]BLICA|APARECIDA|P[ÁA]SCOA|CARNAVAL|CORPUS|PAIX[ÃA]O|TRABALHO/i.test(
                          textoFeriado,
                        );
                      ...
                      /*
                         IMPORTANTE:
                         24H É O PADRÃO NORMAL.
                         NÃO MOSTRAMOS MAIS "24H"
                         DENTRO DO CARD.
                      */
